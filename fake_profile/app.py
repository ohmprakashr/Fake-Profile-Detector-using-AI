...
with tab1:
    ...
    with col3:
        ...
        lang = st.number_input("lang_code (0–7)", min_value=0, max_value=7, value=1)
...
with tab2:
    ...
    if uploaded_file is not None:
        ...
        if all(col in df.columns for col in required_cols):
            ...
            fig = px.bar(counts, x="profile_type", y="count",
                         color="profile_type", text="count")
...
# ==============================================================
# TAB 3: MODEL PERFORMANCE (Demo Only)
# ==============================================================
with tab3:
    st.subheader("Model Performance (Demo Visualization)")

    st.info("""
    ⚠️ For real evaluation, use a labeled test dataset.
    This tab only demonstrates confusion matrix & ROC curve logic.
    """)
